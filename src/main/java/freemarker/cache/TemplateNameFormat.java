...
public abstract class TemplateNameFormat {
     ...
     *
     * @param baseName   Maybe a file name, maybe a directory name. The meaning of file name VS directory name depends on the
     ...
     * @param targetName The name to convert. This usually comes from a template that refers to another template by name. It
     ...
     * becomes to "foo.ftl".
     *
     * @param name The root based name (a name that's either absolute or relative to the root). Not {@code null}.
