...
public class TemplateCache {
     ...
     * @param templateLookupStrategy The {link TemplateLookupStrategy} to use. Can't be {@code null}.
     * @param templateNameFormat     The {link TemplateNameFormat} to use. Can't be {@code null}.
     * @param templateConfigurations The {link TemplateConfigurationFactory} to use. Can be {@code null} (then all templates will use the
     *                               settings coming from the {link Configuration} as is).
     * @param config                 The {link Configuration} this cache will be used for. Can be {@code null} for backward compatibility,
