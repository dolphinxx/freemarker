...
//    }
     ...
     *
     * @param autoEscapingPolicy One of the {link #ENABLE_IF_DEFAULT_AUTO_ESCAPING_POLICY},
     ...
     *
     * @param name Either the name of the output format as it was registered with
     ...
     *
     * @param namingConvention One of the {link #AUTO_DETECT_NAMING_CONVENTION} or {link #LEGACY_NAMING_CONVENTION}
     ...
     * See {link Configuration} for an example of basic usage.
     *
     * @param name                  The name or path of the template, which is not a real path, but interpreted inside the current
     ...
     * @param locale                The requested locale of the template. This is what {link Template#getLocale()} on the resulting
     ...
     * @param customLookupCondition This value can be used by a custom {link TemplateLookupStrategy}; has no effect with the default one.
     ...
     * @param encoding              Deprecated mechanism, {@code null} is the recommended; the charset used to interpret the template
     ...
     *                              specify here.
     * @param parseAsFTL            If {@code true}, the loaded template is parsed and interpreted normally, as a regular FreeMarker
     ...
     * @param ignoreMissing         If {@code true}, the method won't throw {link TemplateNotFoundException} if the template doesn't
     ...
     * names too.
     *
     * @param camelCase If we want the setting names with camel case naming convention, or with snake case (legacy) naming
     *                  convention.
     *                  <p>
    ...
    private void doAutoImports(Environment env, Template t) throws IOException, TemplateException {
        ...
        boolean lazyAutoImports = env.getLazyAutoImports() != null ? env.getLazyAutoImports()
                : env.getLazyImports();
     ...
     *
     * @param namingConvention One of {link #AUTO_DETECT_NAMING_CONVENTION}, {link #LEGACY_NAMING_CONVENTION}, and
