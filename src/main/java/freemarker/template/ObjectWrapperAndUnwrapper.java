...
public interface ObjectWrapperAndUnwrapper extends ObjectWrapper {
     ...
     * {@code null}).
     *
     * @param targetClass The class that the return value must be an instance of (except when the return value is {@code null}).
     ...
     * @throws TemplateModelException If the unwrapping fails for a reason than doesn't fit the meaning of the
