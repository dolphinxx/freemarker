...
//    }
    ...
    public TokenMgrError(String detail, int reason,
        ...
        this.lineNumber = errorLine;  // In J2SE there was no Integer.valueOf(int)
    ...
    public ParseException toParseException(Template template) {
        return new ParseException(getDetail(),
                template,
                getLineNumber() != null ? getLineNumber() : 0,
                getColumnNumber() != null ? getColumnNumber() : 0,
                getEndLineNumber() != null ? getEndLineNumber() : 0,
                getEndColumnNumber() != null ? getEndColumnNumber() : 0);
    }
