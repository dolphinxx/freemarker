...
public abstract class TemplateDateFormatFactory extends TemplateValueFormatFactory {
     ...
     * sufficiently cheap.
     *
     * @param params        The string that further describes how the format should look. For example, when the
     ...
     * @param dateType      {link TemplateDateModel#DATE}, {link TemplateDateModel#TIME}, {link TemplateDateModel#DATETIME} or
     ...
     * @param locale        The locale to format for. Not {@code null}. The resulting format should be bound to this locale
     *                      forever (i.e. locale changes in the {link Environment} must not be followed).
     * @param timeZone      The time zone to format for. Not {@code null}. The resulting format must be bound to this time zone
     *                      forever (i.e. time zone changes in the {link Environment} must not be followed).
     * @param zonelessInput Indicates that the input Java {link Date} is not from a time zone aware source. When this is
     ...
     *                      says.
     * @param env           The runtime environment from which the formatting was called. This is mostly meant to be used for
