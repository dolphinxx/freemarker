...
import static freemarker.template.Configuration.DOLLAR_INTERPOLATION_SYNTAX;
import static freemarker.template.Configuration.LEGACY_INTERPOLATION_SYNTAX;
...
public class FMParser implements FMParserConstants {
     ...
     * @param strictSyntaxMode Whether FreeMarker directives must start with a #
...
// expression syntax.
     ...
     * by parentheses.
     */
    final public Expression AtomicExpression() throws ParseException {
        Expression exp;
        switch ((jj_ntk == -1) ? jj_ntk_f() : jj_ntk) {
            case INTEGER:
            case DECIMAL: {
...
// Should have already return-ed
     ...
     */
    final public ContinueInstruction Continue() throws ParseException {
        Token start;
...
// To prevent parser check loopholes like <#list ...><#macro ...><#break></#macro></#list>.
        ...
        switch ((jj_ntk == -1) ? jj_ntk_f() : jj_ntk) {
            case END_MACRO: {
                ...
                if (isFunction) {
                    if (true) throw new ParseException("Expected function end tag here.", template, end);
                }
                break;
            }
            case END_FUNCTION: {
                ...
                if (!isFunction) {
                    if (true) throw new ParseException("Expected macro end tag here.", template, end);
                }
                break;
            }
            default:
    ...
    final public OutputFormatBlock OutputFormat() throws ParseException {
        Token start;
        Token end;
        Expression paramExp;
        TemplateElements children;
    ...
    final public AutoEscBlock AutoEsc() throws ParseException {
        Token start;
        Token end;
        TemplateElements children;
    ...
    final public NoAutoEscBlock NoAutoEsc() throws ParseException {
        Token start;
        Token end;
        TemplateElements children;
        int lastAutoEscapingPolicy;
    ...
    final public TextBlock WhitespaceText() throws ParseException {
        Token t = null;
        Token start = null;
        t = jj_consume_token(STATIC_TEXT_WS);
        if (stripText && mixedContentNesting == 1 && !preventStrippings) {
     ...
     */
    final public Token UnparsedContent(Token start, StringBuilder buf) throws ParseException {
        Token t;
        label_18:
        while (true) {
            switch ((jj_ntk == -1) ? jj_ntk_f() : jj_ntk) {
    ...
    final public TemplateElements MixedContentElements() throws ParseException {
...
// Note: elem == null when it's was top-level PCData removed by stripText
     ...
     */
    final public MixedContent WhitespaceAndComments() throws ParseException {
        MixedContent nodes = new MixedContent();
        TemplateElement elem;
        TemplateElement begin = null;
        label_22:
     ...
     */
    final public List<Object> StaticTextAndInterpolations() throws ParseException {
        Token t;
